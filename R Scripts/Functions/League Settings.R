...
#Season
season <- 2016
weekNo <- 13   # Set weekNo = 0 for seasonal projections
...
passCompMultiplier <- .1    #0 pts per passing completion
passIncompMultiplier <- -.1   #0 pts per passing incompletion
passYdsMultiplier <- (1/25) #1 pt per 25 passing yds
passTdsMultiplier <- 4      #4 pts per passing td
passIntMultiplier <- -1     #-3 pts per passing interception
...
recMultiplier <- .5          #0 pts per reception
